...
def X(time_moment=None, tau=tau):
    ...
    def x(time_moment, T, ind: List[int]):
        """
        :param t:
        :param T:
        :param ind:
...
def find_tetta_vector():
    column_1 = alpha - F_matr.get("t0") * x_0 - integrate(F * X(t1, t),(t,t0_num,t1_num)) * f - integrate(F * X(t2, t),(t,t0_num,t2_num)) * f
    column_2 = x_T - X(T, t0) * x_0 - integrate(X(T, t) * f, (t, t0_num, T_num))
